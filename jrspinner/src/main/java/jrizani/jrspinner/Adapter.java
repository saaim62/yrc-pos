...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
     ...
     */
    public Adapter(boolean multiple, Listener listener, Context context) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            label.setTypeface(Typeface.createFromAsset(context.getAssets(), "fonts/co_headline_w01_light.ttf"));
        }
